...
public class EditContactActivity extends AppCompatActivity {
    ...
    public void saveContact(View view) {
        ...
        // Edit contact
        EditContactCommand edit_contact_command = new EditContactCommand(contact_list, contact,
                updated_contact, context);
    ...
    public void deleteContact(View view) {
        ...
        // Delete contact
        DeleteContactCommand delete_contact_command = new DeleteContactCommand(contact_list, contact,
                context);
